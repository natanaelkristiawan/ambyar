    ...
    <section class="l-section l-end-screen">
        ...
        <div class="l-section-shrink l-payment-information">
            ...
            <section class="c-end-screen-heading col-xxs-12 u-text-align-center p-t-30 p-r-30 p-l-30">
                ...
                <p class="small-1 secondary p-b-20">IDR&nbsp;<span class="fn-price">95000</span>&nbsp;<span>(Order #1141)</span>.</p>
            ...
            <section class="c-end-screen-payment-method col-xxs-12 p-t-20 p-b-20">
                ...
                <div class="l-section-shrink between-xxs middle-xxs">
                    <div class="panel-left col-xxs-7">
                        <h6 class="heading small negative">IDR <span class="fn-price" id="amount-to-paid">95000</span></h6>
                    </div>
                    <div class="panel-right col-xxs-5 u-text-align-right">
                        <a href="javascript:void(0)" class="o-button btn-small btn-warning fn-copy-text" data-clipboard-text="95000">
                ...
                <div class="l-section-shrink between-xxs middle-xxs">
                    <div class="panel-note col-xxs-12 p-b-20">
                        <div class="c-alert alert-warning">
                            <p class="small-2 medium">You can download / scan QR code below to make payment according to the amount that must be paid using Gojek application</p>
                        </div>
                    </div>
                    <div class="panel-left col-xxs-6">
                        <img src="img/uploads/demo/end-screen/qr--gopay-code.jpg" 
                                srcset="img/uploads/demo/end-screen/qr--gopay-code@2x.jpg 2x, 
                                img/uploads/demo/end-screen/qr--gopay-code@3x.jpg 3x" 
                                class="qr-code" 
                        />
                    </div>
                    <div class="panel-right col-xxs-6 u-text-align-right">
                        <p class="secondary medium small-2 p-b-10">PT. FoodPrint Maju Indonesia Gopay verified account</p>
                        <a href="javascript:void(0)" class="o-button btn-small btn-warning">
                            <i data-feather="download" width="16" height="16"></i>
                            <span class="small-2">Download QR</span>
                        </a>
                    </div>
                </div>                    
            </section>
            ...
            <section class="c-end-screen-payment-method col-xxs-12 p-t-20 p-b-20">
                <div class="l-section-shrink between-xxs middle-xxs">
                    <div class="panel-note col-xxs-12 p-b-20">
                        <div class="c-alert alert-warning">
                            <p class="small-2 medium">Or you can transfer via the phone number below o make payment according to the amount that must be paid using Gojek application</p>
                        </div>
                    </div>
                    <div class="panel-left col-xxs-4">
                        <img src="img/uploads/thumbnails/thumbnail--gopay.png" 
                                srcset="img/uploads/thumbnails/thumbnail--gopay@2x.png 2x, 
                                img/uploads/thumbnails/thumbnail--gopay@3x.png 3x" 
                                class="qr-code" 
                        />
                    </div>
                    <div class="panel-right col-xxs-7 u-text-align-right">
                        <h6 class="heading small primary">+62 899 3138 922</h6>
                        <p class="secondary medium small-2 p-b-10">PT. FoodPrint Maju Indonesia Gopay verified account</p>
                        <a href="javascript:void(0)" class="o-button btn-small btn-warning fn-copy-text" data-clipboard-text="+628993138922">
                            <i data-feather="copy" width="16" height="16"></i>
                            <span class="small-2">Copy phone number</span>
                        </a>
                    </div>
                </div>
            </section>
